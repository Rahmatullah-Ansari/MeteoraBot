...
namespace MeteoraBot.PuppeteerBrowser
{
    ...
    public enum ValueTypes
    {
        ...
        placeholder = 12,
        [Description("innerHTML")] InnerHtml = 13,
        [Description("outerHTML")] OuterHtml = 14,
        [Description("innerText")] InnerText = 15,
        [Description("outerText")] OuterText = 16,
        [Description("dataset.id")] DataId = 17,
        [Description("href")]
        Href = 18,
        [Description("id")] Id = 19,
        [Description("ariaSelected")] AreaSelected = 20
    }
